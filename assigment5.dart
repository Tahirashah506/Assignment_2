...
void main() {
  //Q1
  // List str = ["Tahira", "Shah", "Zabtech", "Hyderabad", "Karachi"];
  // print("String List=${str}");

// //Q2
  // List array = ["Tahira syed", 12, true, false, 20.2, 39];
...
//   //Q4
  // List stu_name = ["tahira", "linta noor", "iqra"];
  ...
  // print("total marks=500");
  // print("tahira obtained marks:${score[1]}");
  // double per1 = score[1] / 500 * 100;
  // print("percentage=${per1}");
  // print("total marks=500");
  // print("linta noor obtained marks:${score[2]}");
